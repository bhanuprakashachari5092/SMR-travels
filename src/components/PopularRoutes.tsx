    ...
    <section id="routes" className="py-20 bg-linear-to-b from-[#EEF6FF] via-[#F8FAFC] to-white relative overflow-hidden border-t border-slate-200/80">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 mb-10">
          ...
          >
            All Top Routes ({POPULAR_ROUTES.length})
          </button>
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1 pt-1">
                  <p className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Available Cabs:</p>
                  <p className="text-xs font-semibold text-slate-800">{route.popularVehicles}</p>
                </div>
