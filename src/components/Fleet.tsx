      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0B1F3A] tracking-tight">
            Our Premium <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1769FF] via-[#3157D5] to-[#00B8D9]">Fleet</span>
          </h2>
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-xl text-xs font-bold transition-all duration-300 ${
                selectedCategory === cat
                  ? 'bg-gradient-to-r from-[#1769FF] to-[#00B8D9] text-white shadow-md shadow-blue-500/20'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {filteredFleet.map((car) => (
            ...
            >
              {/* Image & Badge Header */}
              <div className="relative h-64 sm:h-72 overflow-hidden bg-gradient-to-b from-[#F0F6FF] via-white to-[#F8FAFC] flex items-center justify-center p-4">
                <img
                  src={car.image}
                  alt={car.name}
                  className="max-h-[200px] sm:max-h-[230px] w-auto object-contain transform group-hover:scale-105 transition-transform duration-700 drop-shadow-[0_12px_24px_rgba(11,31,58,0.15)]"
                />
                ...
                {car.isPopular && (
                  <div className="absolute top-4 right-4 px-3.5 py-1 rounded-full bg-gradient-to-r from-[#C9A227] to-[#B08C1E] text-xs font-bold text-white shadow-md">
                    POPULAR CHOICE
                  </div>
                )}
              </div>
              ...
              <div className="p-6 sm:p-8 flex-1 flex flex-col justify-between bg-white">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl font-bold text-sm text-white bg-gradient-to-r from-[#1769FF] via-[#1254D4] to-[#00B8D9] hover:from-[#1254D4] hover:to-[#00B8D9] shadow-lg shadow-blue-500/20 hover:shadow-cyan-500/30 transition-all duration-300"
                >
