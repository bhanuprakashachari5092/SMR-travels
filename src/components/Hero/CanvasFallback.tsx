...
export const CanvasFallback: React.FC = () => {
  return (
    <div className="relative w-full h-full min-h-[400px] flex items-center justify-center rounded-3xl overflow-hidden bg-white/80 border border-slate-200 shadow-2xl group">
      {/* Background radial glow */}
      <div className="absolute inset-0 bg-gradient-to-tr from-white via-slate-50 to-blue-50/60" />
      ...
      <div className="absolute inset-0 opacity-30 bg-[linear-gradient(to_right,#e2e8f0_1px,transparent_1px),linear-gradient(to_bottom,#e2e8f0_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_100%)]" />

      {/* Fallback Luxury Vehicle Silhouette & Visual */}
      <div className="relative z-10 flex flex-col items-center justify-center p-6 text-center">
        <div className="relative mb-6">
          <div className="absolute -inset-4 bg-gradient-to-r from-[#1769FF] via-[#00B8D9] to-[#1769FF] rounded-full opacity-20 blur-xl group-hover:opacity-40 transition duration-500" />
